...
class AccountChartTemplate(models.Model):
    ...
    def _prepare_all_journals(self, acc_template_ref, company, journals_dict=None):
        ...
        journals = [{'name': _('FACTURA DE VENTA'), 'type': 'sale', 'code': _('F001'), 'favorite': True, 'color': 11, 'sequence': 5},
                    {'name': _('BOLETA DE VENTA'), 'type': 'sale', 'code': _('B001'), 'favorite': True, 'color': 11, 'sequence': 11},
                    {'name': _('NOTA DE CRÉDITO (Factura)'), 'type': 'sale', 'code': _('F001'), 'favorite': True, 'color': 11, 'sequence': 12},
                    {'name': _('NOTA DE DÉBITO (Factura)'), 'type': 'sale', 'code': _('F001'), 'favorite': True, 'color': 11, 'sequence': 13},
                    ...
                    {'name': _('NOTA DE CRÉDITO (Boleta)'), 'type': 'sale', 'code': _('B001'), 'favorite': True, 'color': 11, 'sequence': 14},
                    {'name': _('NOTA DE DÉBITO (Boleta)'), 'type': 'sale', 'code': _('B001'), 'favorite': True, 'color': 11, 'sequence': 15}
                    ]
